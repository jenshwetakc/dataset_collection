...
DEFAULT_CAPTURE_FULL_PAGE = False
...
# ==========================================================
# Save Complete / All-Classes Annotation JSON
# ==========================================================
...
def save_all_annotations(
    *,
    ...
    """
    Save the complete extracted annotation set once per image.

    This JSON is the source of truth.  It includes every valid,
    visible annotation class before profile filtering.  Profile-specific
    YOLO labels (big_components, small_elements, etc.) can therefore be
    regenerated later without rerendering the page or taking a new image.
    """
