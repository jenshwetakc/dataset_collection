# for both full page and viewport
...
# ==========================================================
# Baemin Render Wrapper
# ==========================================================

async def render_baemin_page(
    browser,
    sample_index: int,
    page_type: str,
    template_name: str,
    ...
    """
    Baemin-specific wrapper around the common renderer.
    ...
    - configurable scroll percentages

    All extraction and export logic remains in the
    shared renderer.
    """
