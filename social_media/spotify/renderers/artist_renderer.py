...
from social_media.spotify.generators.artist_generator import (
        ...
        try:
            ...
            for sample_index in range(
                ...
                for theme_mode in (
                    ...
                    print(
                        f"Spotify Artist Sample: "
                        f"{sample_index}"
                    )

                    print(
                        f"Artist: "
                        f"{artist_data['artist']['name']}"
                    )
                    ...
                    print(
                        f"Popular Tracks: "
                        f"{len(artist_data['popular_tracks'])}"
                    )

                    print(
                        f"Discography: "
                        f"{len(artist_data['discography'])}"
                    )

                    print(
                        f"Related Artists: "
                        f"{len(artist_data['related_artists'])}"
                    )
