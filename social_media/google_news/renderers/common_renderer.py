...
# ==========================================================
# Google News Render Wrapper
# ==========================================================

async def render_google_news_page(
    browser,
    sample_index: int,
    page_type: str,
    template_name: str,
    ...
    """
    Google News-specific wrapper around the common renderer.

    All screenshot capture, scrolling, annotation extraction,
    visibility filtering, JSON export, YOLO export, and
    visualization logic remain inside the shared renderer.
    """
