...
from social_media.email.generators.attachment_generator import (
    generate_attachment_data,
)
    ...
    async with async_playwright() as playwright:
        ...
        for sample_index in range(
            ...
            print(
                ...
                f"state={attachment['state']} "
                f"theme={theme['mode']} "
                f"files={len(attachment['files'])}"
            )
