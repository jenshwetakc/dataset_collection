...
from social_media.google_fit.generators.hydration_generator import (
    HYDRATION_STATES,
        ...
        try:
            ...
            for sample_index in range(
                ...
                for state in states:
                    ...
                    # --------------------------------------
                    # Generate once so all viewport/theme
                    # variants share the same underlying
                    # hydration content.
                    # --------------------------------------
