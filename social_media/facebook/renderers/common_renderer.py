# social_media/facebook/renderer.py
...
# ==========================================================
# Facebook Render Wrapper
# ==========================================================

async def render_facebook_page(
    browser,
    sample_index: int,
    page_type: str,
    template_name: str,
    ...
    """
    Facebook-specific wrapper around the common renderer.

    Screenshot capture, scrolling, visibility filtering,
    annotation extraction, YOLO export, JSON export and
    visualization remain inside:
