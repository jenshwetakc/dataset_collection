...
from social_media.google_fit.generators.home_generator import (
    generate_home_data,
)
    ...
    async with async_playwright() as playwright:
        ...
        try:
            ...
            for sample_index in range(
                ...
                # ------------------------------------------
                # Generate page data once per sample.
                #
                # This ensures light/dark and viewport
                # variants represent the same underlying UI.
                # ------------------------------------------
