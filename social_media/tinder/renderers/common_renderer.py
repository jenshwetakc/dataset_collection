...
# ==========================================================
# Tinder Render Wrapper
# ==========================================================

async def render_tinder_page(
    browser,
    sample_index: int,
    page_type: str,
    template_name: str,
    ...
    """
    Tinder-specific wrapper around the common renderer.

    Screenshot capture, scrolling, annotation extraction,
    clipping, YOLO export, JSON export, and visualization
    remain in:
