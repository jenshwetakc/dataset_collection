...
from social_media.google_fit.generators.activity_picker_generator import (
...
def resolve_states() -> list[str]:
    ...
    if STATE_MODE == "selected":
        ...
        if invalid:
            ...
            raise ValueError(
                f"Unknown activity picker states: "
                f"{sorted(invalid)}"
            )
...
async def render_activity_picker():
