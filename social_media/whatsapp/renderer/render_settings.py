...
from social_media.whatsapp.generators.settings_generator import (
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        for sample_index in range(
            ...
            print(
                "QR:",
                settings["profile"]["show_qr"]
            )

            print(
                "Camera:",
                settings["profile"]["show_camera"]
            )
