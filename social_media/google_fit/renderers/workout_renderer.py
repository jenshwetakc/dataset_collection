...
from social_media.google_fit.generators.workout_generator import (
    WORKOUT_STATES,
        ...
        try:
            ...
            for sample_index in range(
                ...
                for state in states:
                    ...
                    # --------------------------------------
                    # Generate state data ONCE.
                    #
                    # Same workout data is therefore used
                    # across viewport/theme variants.
                    # --------------------------------------
